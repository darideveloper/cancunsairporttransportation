...
## Purpose
Add schema.org Product and Offer microdata to VehicleBuyCard component to enable rich snippets in search results and improve SEO, following the same pattern established by the Testimonial component's schema.org/Review implementation.
