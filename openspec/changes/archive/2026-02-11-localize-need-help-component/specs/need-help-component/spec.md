...
@spec-id: need-help-component
@version: 1.0.0
@status: draft

## Overview

The `NeedHelp` component provides quick access to contact information and builds trust through certifications. It must be localized and accessible.
