...
## Purpose
Ensure all pages maintain proper HTML heading hierarchy (H1 → H2 → H3, etc.) without skipping levels, as required by SEO best practices and accessibility standards (WCAG 2.1).
