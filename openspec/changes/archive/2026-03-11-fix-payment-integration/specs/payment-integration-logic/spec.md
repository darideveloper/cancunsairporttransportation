...
## Purpose
Standardize the frontend registration and payment flow by ensuring correct data mapping, robust response handling (including "hoisted" IDs), and persistent reservation tracking.
