# info-icon-card Specification

## Purpose
A generic section component (renamed from transportation-services-section) that displays a heading (with optional icons) and a grid of information/service cards.
...
- Requirement: Architecture: Self-contained Components (from transportation-services-section) - Moving towards prop-driven data.
